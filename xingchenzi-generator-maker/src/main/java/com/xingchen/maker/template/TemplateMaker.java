package com.xingchen.maker.template;
...
import com.xingchen.maker.template.eumms.FileFilterRangeEnum;
import com.xingchen.maker.template.eumms.FileFilterRuleEnum;
import com.xingchen.maker.template.model.*;
...
public class TemplateMaker {
    ...
    private static Meta.FileConfig.FileInfo makeFileTemplate(TemplateMakerModelConfig templateMakerModelConfig, String sourceRootPath, File inputFile,TemplateMakerFileConfig.FileInfoConfig fileInfoConfig) {
        ...
        //之前不存在的模板文件，并且这次替换没有修改文件的内容，才是静态生成
        // 和原文件一致，没有挖坑，则为静态生成
        if(!hasTemplateFile){
            if(contentEquals){
                // 输出路径 = 输入路径
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath1 = "src/main/java/com/xingchen/springbootinit/common";
        ...
        modelInfoConfig1.setDefaultValue("jdbc:mysql://localhost:3306/my_db111");
        modelInfoConfig1.setReplaceText("jdbc:mysql://localhost:3306/my_db111");
